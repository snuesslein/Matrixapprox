...
There are different approaches to approximate matrices using structured matrices to reduce the computational cost.% more efficient structures 
\textcolor{gray}{
Aims:}
...
\todo{keywords? Classification? remove gray text}
