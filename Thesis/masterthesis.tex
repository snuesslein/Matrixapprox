...
I choose to use $K=15$ based on the approximations done in Section\,\ref{sec:Choose_K}.
...
The threshold value is set to $\epsilon = 0.35 \|A\|_H$, based on the initial segmentation.
The result is illustrated in Figure\,\ref{fig:mobilenet_seperation_comp}.
\begin{figure}[!htb]
	\centering
