...
Matrix structures with reduced order. Different representations.

Description of structure of thesis
...
\todo[inline]{eventually move this to introduction}
...
\begin{equation}\label{eq:System_mat_vec}
	y = Tu,
\end{equation}
where the matrix $T$ describes the system.
