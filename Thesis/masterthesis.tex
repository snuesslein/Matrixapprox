...
\todo[inline]{motivatio, outline previous ideas (nuclear norm with interior points, compute nuclear norm with %\verb|brand_fast_2006| 
	but expencive )}
...
\footnote{For an trivial example consider the identity matrix as sequentially semiseperabel matrix with full rank}
